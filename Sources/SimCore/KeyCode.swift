...
// origin: Sources/AXe/Types/KeyCode.swift — MIT License
...
/// One key press: a USB HID usage code plus whether Left Shift must be held.
public struct KeyEvent: Equatable, Sendable {
    public let keyCode: Int
    public let shift: Bool

    public init(keyCode: Int, shift: Bool) {
